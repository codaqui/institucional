...
- [Documentação Python sobre herança](https://docs.python.org/3/tutorial/classes.html#inheritance)
- [Método Resolution Order (MRO)](https://www.python.org/download/releases/2.3/mro/)
- [Documentação sobre ABC (Abstract Base Classes)](https://docs.python.org/3/library/abc.html)
- [Real Python: Inheritance and Composition in Python](https://realpython.com/inheritance-composition-python/)
- [Python Duck Typing](https://realpython.com/lessons/duck-typing/)
:::
