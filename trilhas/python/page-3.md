...
- [Documentação oficial sobre loops for](https://docs.python.org/3/tutorial/controlflow.html#for-statements)
- [Documentação oficial sobre loops while](https://docs.python.org/3/reference/compound_stmts.html#the-while-statement)
- [Documentação sobre list comprehensions](https://docs.python.org/3/tutorial/datastructures.html#list-comprehensions)
:::
