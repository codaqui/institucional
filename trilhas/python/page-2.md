...
- [Documentação oficial sobre expressões condicionais](https://docs.python.org/3/tutorial/controlflow.html#if-statements)
- [Documentação sobre operadores de comparação](https://docs.python.org/3/library/stdtypes.html#comparisons)
:::
