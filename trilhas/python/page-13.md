...
- [Documentação oficial Python sobre classes](https://docs.python.org/3/tutorial/classes.html)
...
- [PEP 8 - Conveções de estilo para código Python](https://peps.python.org/pep-0008/)
:::
