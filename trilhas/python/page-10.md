...
- [Documentação do módulo os.path](https://docs.python.org/3/library/os.path.html)
- [Documentação do módulo shutil](https://docs.python.org/3/library/shutil.html)
:::
...
[Avance para a próxima aula →](/trilhas/python/page-11)

[← Voltar para Módulos](/trilhas/python/page-9)
