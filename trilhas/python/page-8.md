...
- [Hierarquia de exceções embutidas](https://docs.python.org/3/library/exceptions.html#exception-hierarchy)
- [Documentação sobre o módulo logging](https://docs.python.org/3/library/logging.html)
- [Documentação sobre pdb (Python Debugger)](https://docs.python.org/3/library/pdb.html)
:::
