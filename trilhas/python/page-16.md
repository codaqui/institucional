...
- [Documentação oficial - What's New](https://docs.python.org/3/whatsnew/)
- [PEPs (Python Enhancement Proposals)](https://peps.python.org/)
- [Real Python: Cool New Features in Python 3.10](https://realpython.com/python310-new-features/)
- [Real Python: Cool New Features in Python 3.11](https://realpython.com/python311-new-features/)
- [Real Python: Cool New Features in Python 3.12](https://realpython.com/python312-new-features/)
:::
