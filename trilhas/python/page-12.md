...
- [Documentação oficial sobre decoradores](https://docs.python.org/3/glossary.html#term-decorator)
- [PEP 318 - Decoradores para Funções e Métodos](https://peps.python.org/pep-0318/)
- [Documentação do módulo functools](https://docs.python.org/3/library/functools.html)
- [Real Python: Decoradores em Python](https://realpython.com/primer-on-python-decorators/)
:::
