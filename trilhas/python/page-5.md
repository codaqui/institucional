...
:::info[Lista Completa]
Consulte a [documentação oficial](https://docs.python.org/3/library/functions.html) para uma lista completa das funções integradas em Python.
:::
...
- [Documentação oficial sobre funções](https://docs.python.org/3/tutorial/controlflow.html#defining-functions)
- [Documentação sobre funções integradas](https://docs.python.org/3/library/functions.html)
- [Python PEP 8 - Guia de Estilo](https://peps.python.org/pep-0008/#function-and-variable-names)
:::
