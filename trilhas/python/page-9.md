...
- [Guia do Python Packaging Authority](https://packaging.python.org/en/latest/tutorials/packaging-projects/)
- [Índice de Pacotes Python (PyPI)](https://pypi.org/)
- [Biblioteca Padrão Python](https://docs.python.org/3/library/)
:::
