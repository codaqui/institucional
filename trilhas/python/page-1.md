...
<details>
<summary>Regras Importantes</summary>
...
:::info[Exemplos de nomes válidos e inválidos]
### Nomes Válidos
...
[Documentação oficial sobre tipos numéricos](https://docs.python.org/3/library/stdtypes.html#numeric-types-int-float-complex)
:::

### 2. Texto (str)

:::info[Exemplos de strings]
```python
nome = "Python"
mensagem = 'Olá, mundo!'
...
[Documentação oficial sobre strings](https://docs.python.org/3/library/stdtypes.html#text-sequence-type-str)
...
[Documentação oficial sobre booleanos](https://docs.python.org/3/library/stdtypes.html#truth-value-testing)
...
- [Documentação sobre listas](https://docs.python.org/3/tutorial/datastructures.html#more-on-lists)
- [Documentação sobre tuplas](https://docs.python.org/3/tutorial/datastructures.html#tuples-and-sequences)
- [Documentação sobre dicionários](https://docs.python.org/3/tutorial/datastructures.html#dictionaries)
- [Documentação sobre conjuntos](https://docs.python.org/3/tutorial/datastructures.html#sets)
:::
...
[Documentação oficial sobre None](https://docs.python.org/3/library/constants.html#None)
...
Não se esqueça de consultar a [documentação oficial do Python](https://docs.python.org/3/) para aprofundar seus conhecimentos. A seção de [Tutorial](https://docs.python.org/3/tutorial/index.html) é especialmente útil para iniciantes.
:::
