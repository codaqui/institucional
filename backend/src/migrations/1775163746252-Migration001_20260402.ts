...
export class Migration001202604021775163746252 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."members_role_enum" AS ENUM('membro', 'finance-analyzer', 'admin')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."accounts_type_enum" AS ENUM('BANK', 'VIRTUAL_WALLET', 'EXTERNAL', 'EXPENSE')`);
        ...
        await queryRunner.query(`ALTER TABLE "account_transfer_requests" ADD CONSTRAINT "FK_dd79f9456dced1592d8aba2da37" FOREIGN KEY ("requestedById") REFERENCES "members"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "account_transfer_requests" ADD CONSTRAINT "FK_4c82e7266d956bac160b44e4070" FOREIGN KEY ("sourceAccountId") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "account_transfer_requests" ADD CONSTRAINT "FK_4c971cb2930342c93a65c9d7594" FOREIGN KEY ("destinationAccountId") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "account_transfer_requests" ADD CONSTRAINT "FK_2b7664fff8d2f39f2f21fb39499" FOREIGN KEY ("reviewedById") REFERENCES "members"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_c2edf5312a2dff9e7607e4b4a0c" FOREIGN KEY ("sourceAccountId") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_e704cd38335d6b334f2fce8caf9" FOREIGN KEY ("destinationAccountId") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reimbursement_requests" ADD CONSTRAINT "FK_6505a1b013880200afab9fee6a6" FOREIGN KEY ("memberId") REFERENCES "members"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reimbursement_requests" ADD CONSTRAINT "FK_ee0eb8940b611fb5b1ee7618e17" FOREIGN KEY ("accountId") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reimbursement_requests" ADD CONSTRAINT "FK_a2f2db563c3909c44348a1298b5" FOREIGN KEY ("reviewedById") REFERENCES "members"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "reimbursement_requests" DROP CONSTRAINT "FK_a2f2db563c3909c44348a1298b5"`);
        await queryRunner.query(`ALTER TABLE "reimbursement_requests" DROP CONSTRAINT "FK_ee0eb8940b611fb5b1ee7618e17"`);
        await queryRunner.query(`ALTER TABLE "reimbursement_requests" DROP CONSTRAINT "FK_6505a1b013880200afab9fee6a6"`);
        ...
        await queryRunner.query(`ALTER TABLE "account_transfer_requests" DROP CONSTRAINT "FK_2b7664fff8d2f39f2f21fb39499"`);
        await queryRunner.query(`ALTER TABLE "account_transfer_requests" DROP CONSTRAINT "FK_4c971cb2930342c93a65c9d7594"`);
        await queryRunner.query(`ALTER TABLE "account_transfer_requests" DROP CONSTRAINT "FK_4c82e7266d956bac160b44e4070"`);
        await queryRunner.query(`ALTER TABLE "account_transfer_requests" DROP CONSTRAINT "FK_dd79f9456dced1592d8aba2da37"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."reimbursement_requests_status_enum"`);
        await queryRunner.query(`DROP TABLE "transactions"`);
        await queryRunner.query(`DROP TABLE "account_transfer_requests"`);
        await queryRunner.query(`DROP TYPE "public"."account_transfer_requests_status_enum"`);
