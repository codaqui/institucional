...
export const timelineEvents: TimelineEvent[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "12 participantes contemplados no primeiro ciclo",
      "8 bolsas concedidas (R$ 50/mês por 6 meses)",
      "3 computadores doados para participantes",
    ...
    stats: [
      { label: "Participantes", value: "12", icon: "👩‍💻" },
    ...
    highlights: [
      ...
      "Primeira trilha de Python concluída com 12 participantes",
    ],
  },
  {
    year: 2022,
    ...
    items: [
      ...
      "~15 participantes recorrentes, ~30 participantes no total do período",
  ...
  },
  {
    ...
    items: [
      ...
      "17 participantes mentorados individualmente",
    ...
    stats: [
      ...
      { label: "Participantes", value: "17", icon: "👩‍💻" },
      { label: "Discord", value: "501", icon: "💬" },
  ...
  },
  {
    ...
    items: [
      "1º Semestre: 15 participantes em aulas virtuais",
      "2º Semestre: 10 participantes em aulas virtuais",
      "95 mentorias realizadas totalizando 66 horas",
      "45 participantes mentorados individualmente",
    ...
    stats: [
      ...
      { label: "Participantes", value: "45", icon: "👩‍💻" },
