...
- 💻 Doação de computadores para escola no RJ
- 👥 Lançamento do Projeto Mentoria

### 📈 Crescimento

- 💰 Financiamento Coletivo iniciado
- 🌐 Site remodelado
- 👔 Contratação de apoio organizacional
- 📊 Transparência mensal via Apoia.se
- 🎁 Doação de computadores da Cortex Intelligence

---

## 📅 2021-2022 - Consolidação

:::note[Período de Estruturação]
...
- Google Education (Google AdGrants)
- GitHub Education (GitHub Campus)
- WorkAdventure (espaço virtual para aulas)
...
| Métrica | Valor |
|---------|-------|
| 🎓 Alunos contemplados | 12 |
| 💰 Bolsas concedidas | 8 (R$ 50/6 meses) |
| 💻 Computadores doados | 3 |
| 📚 Trilhas completas | 1 (Python) |

### 📜 Formalização

- 📚 **Embasamento pedagógico** desenvolvido pela pedagoga [Lucia Maria Sendim Vieira](https://www.escavador.com/sobre/560423998/lucia-maria-sendim-vieira), alinhado aos nossos valores educacionais
- 📄 **Constituição jurídica** da Associação Codaqui (CNPJ: 44.593.429/0001-05)
...
- 🏫 Conversa com Zaedy Sayão sobre educação e projetos sociais
- 💼 Primeiro emprego remoto do nosso Fundador
