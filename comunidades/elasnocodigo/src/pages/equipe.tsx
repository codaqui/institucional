...
export default function EquipeElasNoCodigoPage(): React.JSX.Element {
  return (
    <Layout
          ...
          <Container maxWidth="lg">
            <Stack spacing={2} maxWidth={760}>
              ...
              <Typography variant="h6" sx={{ opacity: 0.95, fontWeight: 400 }}>
                Conheça nossas voluntárias e conecte-se. A {community.shortName} é formada
                por mulheres que atuam para promover a diversidade na tecnologia.
              </Typography>
            </Stack>
          </Container>
        </Box>
        ...
        <Container maxWidth="lg" sx={{ py: { xs: 6, md: 8 } }}>
          <Box component="section" sx={{ mb: 8 }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 3, maxWidth: 700 }}>
              Nossa equipe é composta por mulheres voluntárias que apoiam a inclusão no mercado de tecnologia.
            </Typography>
            <Divider sx={{ mb: 4 }} />
