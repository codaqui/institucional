    ...
    >
      ...
      <Box
        sx={{
          ...
          inset: 0,
          background: isDark
            ? `radial-gradient(ellipse 80% 70% at ${isRight ? "85%" : "15%"} 50%, ${primaryDark}30 0%, transparent 60%),
               linear-gradient(135deg, ${primaryDark}15 0%, #050a08 55%)`
            : `radial-gradient(ellipse 80% 70% at ${isRight ? "85%" : "15%"} 50%, ${primary}18 0%, transparent 60%),
               linear-gradient(135deg, #ffffff 0%, #e8f5ed 55%)`,
          zIndex: 0,
        }}
      />

      {/* Hero image with duotone treatment */}
      <Box
        sx={{
          position: "absolute",
          [isRight ? "right" : "left"]: { xs: "auto", sm: "-8%", md: "-2%", lg: "5%", xl: "10%" },
          left: isRight ? { xs: "0%", sm: "auto" } : { xs: "0%", sm: "auto" },
          bottom: 0,
          top: { xs: 0, md: 0 },
      ...
      >
        <Grid container spacing={4} alignItems="center" justifyContent={isRight ? "flex-start" : "flex-end"}>
